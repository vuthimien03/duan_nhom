                                    ...
                                    <?php foreach ($cate as $cates): ?>
                                        ...
                                        <div class="card">
                                            <div class="card-heading">
                                                <a href="index.php?act=spothers&cate_id=<?= $cates['cate_id'] ?>"
    ...
    <ul class="pagination justify-content-center">
        ...
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item "><a class="page-link  bg-secondary text-white"
                    href="index.php?act=product&page=<?= $page ?>"><?= $page ?></a></li>
            <li class="page-item "><a class="page-link" href="index.php?act=product&page=<?= $page + 1 ?>"><?= ($page + 1) > $page_count ? '<>' : ($page + 1) ?></a></li>
            <li class="page-item"><a class="page-link"
