                                    ...
                                    <?php foreach ($cate as $cates): ?>
                                        ...
                                        <div class="card">
                                            <div class="card-heading">
                                                <a class="text-decoration-none" href="index.php?act=spothers&cate_id=<?= $cates['cate_id'] ?>"
...
?>
<ul class="pagination justify-content-center">
    <li class="page-item"><a class="page-link" href="index.php?act=product&page=<?= ($page - 1) > 0 ? ($page - 1) : 1 ?> ">Previous</a></li>
    <li class="page-item"><a class="page-link" href="index.php?act=sp"><?= $page ?></a></li>
    <li class="page-item"><a class="page-link" href="index.php?act=product&page=<?= $page + 1 ?>">2</a></li>
    <li class="page-item"><a class="page-link" href="index.php?act=product&page=<?= ($page + 1) > $page_count ? $page_count : ($page + 1) ?> ">Next</a></li>
  </ul>
  </ul>
