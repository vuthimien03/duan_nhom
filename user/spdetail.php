    ...
    <div>
        <section class="product-details spad">
            <div class="container">
                ...
                <div class="mx-5" style="margin: 5% 0;">
             ...
             ?>
 <form action="index.php?act=spdetail&ma_sp=<?= $_GET['ma_sp'] ?>&cate_id=<?= $_GET['cate_id']?>" method="post">
    <label for="">Leave your comment</label> <br>
    <input type="hidden" name="cmt_date" value="<?= date("y-m-d") ?>">
    <input type="hidden" name="cmter" value="<?= $_SESSION['user']['username'] ?>">
    <input type="hidden" name="cmt_masp" value="<?= $_GET['ma_sp'] ?>">
    <input type="text" name="cmt_content" id=""> <br>
