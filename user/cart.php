                            ...
                            <table class="text-center">
                                ...
                                <tbody>
                                    ...
                                    foreach ($_SESSION['giohanguser'] as $itemuser):
                                        ...
                                        $tt = (int) $itemuser[2] * (int) $itemuser[3];
                                        $total += $tt;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="../upload/<?= $itemuser[1] ?>" alt="" width="100px" height="100px">
