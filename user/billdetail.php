        ...
        <div class="container">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td  class="font-weight-bold">
                                           <span class="bg-success text-white"><?= $b['ma_hd'] ?></span> 
                                        </td>
                                        <td class="text-success font-weight-bold">
                                            <?= number_format($b['tong_tien'], 0, ',') ?>
                                        ...
                                        <td colspan="2">
                                            Họ tên:
                                           <span class="text-info font-weight-bold"><?= $b['hoten'] ?></span>  <br>
                                            Địa chỉ:
                                            <span class="text-info font-weight-bold"><?= $b['diachi'] ?></span> <br>
                                            SDT:
                                            <span class="text-info font-weight-bold"><?= $b['sdt'] ?> </span> <br>
                                        </td>
                                        <td class="cart__price text-danger">
                                            <?php $payment = [1, 2, 3];
                                            if ($b['payment'] == $payment[0]) {
                                                echo "Thanh toán khi nhận hàng!";
                                            } elseif ($b['payment'] == $payment[1]) {
                                                echo "Thanh toán qua tài khoản ngân hàng!";
                                            } elseif ($b['payment'] == $payment[2]) {
                                       ...
                                       <td>
                                       <img src="upload/<?= $b['hasp']?>" alt="" width="100px" height="100px">
                                       </td>
                                    </tr>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="cart__btn">
                        <a href="user/index.php?act=home" class="btn btn-info bg-info text-white">Về trang chủ</a>
                    </div>
                </div>
