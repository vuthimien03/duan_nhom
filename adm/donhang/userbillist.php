        ...
        <div class="container">
                                ...
                                foreach ($a as $h){
                                    ...
                                    <tr>
                                        ...
                                        <td class="cart__price text-danger">
                                            <?php $payment = [1, 2, 3];
                                            if ($h['payment'] == $payment[0]) {
                                                echo "Thanh toán khi nhận hàng!";
                                            } elseif ($h['payment'] == $payment[1]) {
                                                echo "Thanh toán qua tài khoản ngân hàng!";
                                            } elseif ($h['payment'] == $payment[2]) {
                                        ...
                                        <td ><a href="index.php?act=billdetail&ma_hd=<?=$h['ma_hd']?>">See details</a></td>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="cart__btn">
                        <a href="index.php?act=produ" class="btn btn-info bg-info text-white">Tiếp tục mua</a>
                    </div>
                </div>
