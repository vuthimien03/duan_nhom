    ...
    <section class="product spad">
        <div class="container">
            ...
            <div class="row property__gallery">
                ...
                <form action="index.php?act=addstt" method="post" enctype="multipart/form-data" class="checkout__form">
                    <div class="checkout__form__input">
                        <label for="">Bills' ID</label> <br>
                        <input type="text" name="ma_hd" value="<?= $_GET['ma_hd']?>">
                    </div>
                    <div class="checkout__form__input">
